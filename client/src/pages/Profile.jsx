  ...
  return (
    <div className='p-3 max-w-sm mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4' >
        ...
        <img onClick={() => fileRef.current.click()} src={currentUser.avatar || formData.avatar} alt="profile" className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2' style={premiumStyle} />
