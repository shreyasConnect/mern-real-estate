                ...
                <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                    <div className="flex flex-col gap-4 flex-1">
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <div className="flex items-center gap-2">
                                <input type="number" id="regularPrice" required className='p-3 border border-gray-300 rounded-lg' min='50'
                                    max='10000000' onChange={handleChange}
                            ...
                            {formData.offer && (
                                <div className="flex items-center gap-2">
                                    <input type="number" id="discountedPrice" required className='p-3 border border-gray-300 rounded-lg' min='0'
                                        max='10000000' onChange={handleChange}
